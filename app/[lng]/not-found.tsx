...
export default function NotFound() {
  return (
    ...
    >
      ...
      >
        <h1 className="mt-auto font-black text-8xl opacity-60 sm:text-9xl">404</h1>

        <h2 className="font-bold text-xl opacity-90 sm:text-5xl">페이지를 찾을 수 없습니다</h2>
        <p className="font-light text-sm opacity-70 sm:mt-2 sm:text-base">
          존재하지 않는 페이지로 접근하였습니다
        </p>
