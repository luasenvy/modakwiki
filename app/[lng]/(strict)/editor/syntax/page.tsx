...
각주의 설명은 문서 어디에 어떤 순서로 작성하든 영향을 받지 않고 본문에 표시된 각주의 순서대로 문서의 최하단에 순서대로 나열됩니다. 관리를 위해서 각주의 설명을 작성할 때에는 위 예제처럼 각주를 사용한 문단과 가까운곳에 작성하거나 항상 최하단에 모아 작성하는 형식을 취하는 것이 좋습니다.
