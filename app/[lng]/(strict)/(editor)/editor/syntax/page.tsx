...
모닥위키는 알림용 배너 문법을 지원합니다. \`!\` 문자를 시작으로 빈 줄을 만날때까지 알림으로 인식합니다. 첫번째 줄은 제목이되고 나머지 줄은 설명이 됩니다. 설명내 줄바꿈은 띄어쓰기를 2회 반복한 후 다음줄을 입력하면 됩니다. 관리 편의상 알림에 대한 문단은 모두 느낌표로 시작하도록 하는 것이 좋습니다. 
