...
![로고-256 width-256](${Logo.src})
![로고-4096 width-4096](${Logo.src})

![로고](${Logo.src})
~~~

크기를 조정하고 싶을 때에는 명칭에 \`width-[px]\` 또는 \`height-[px]\` 문법을 사용할 수 있습니다. 이미지 의 크기는 최대 크기를 설정하는 방식이므로 아무리 크게 설정하여도 문서를 벗어날 수 없으며 최대 크기보다 작은 이미지를 사용할 경우 계단 현상이 발생할 수 있습니다. 이미지의 크기를 설정하지 않을 경우 항상 영역을 가득 채우도록 작동합니다.

| width-32            | width-64            | width-128           | width-256       | 
| :----------------: | :----------------: | :----------------: | :----------------: | 
| ![로고-32 width-32](${Logo.src}) | ![로고-64 width-64](${Logo.src}) | ![로고-128 width-128](${Logo.src}) | ![로고-256 width-256](${Logo.src}) |
