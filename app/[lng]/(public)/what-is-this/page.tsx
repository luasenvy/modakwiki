...
모닥위키는 개인정보 처리를 위한 보안 기능과 관리 기능이 모두 구성되어 있지만 개인정보 보호법을 포함한 다양한 법률적 문제를 최대한 지원하기 전까지 비회원제를 유지할 계획입니다. 콘텐츠 작성은 회원만 가능하지만 열람은 누구나 가능합니다.

### 회원 역할 체계

모든 회원은 동일한 권리와 대우를 받습니다. 회원은 각자 역할을 부여받을 수 있으며 역할마다 사용할 수 있는 기능의 범위가 달라지고 이는 더 큰 책임이 부과됨을 의미합니다.

|         기능        |  비회원  |  준회원  |  정회원  |  편집자  |  검수자  |  관리자  |
|:--------------------|:--------:|:--------:|:--------:|:--------:|:--------:|:--------:|
| 콘텐츠 열람         |    O     |    O     |    O     |    O     |    O     |    O     |
| 콘텐츠 댓글 열람    |    X     |    O     |    O     |    O     |    O     |    O     |
| 콘텐츠 댓글 작성    |    X     |    X     |    O     |    O     |    O     |    O     |
| 문서 작성           |    X     |    X     |    X     |    O     |    O     |    O     |
| 포스트 작성         |    X     |    X     |    X     |    O     |    O     |    O     |
| 콘텐츠 승인         |    X     |    X     |    X     |    X     |    O     |    O     |
| 회원 관리           |    X     |    X     |    X     |    X     |    X     |    O     |
