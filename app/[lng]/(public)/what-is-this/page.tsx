...
모닥위키는 \`문서\`와 \`기고\` 두가지 형태의 콘텐츠를 제공합니다. 각 콘텐츠의 특성에 따라 작성 및 관리 방식이 다릅니다.

### 위키문서

위키문서는 공동 편집이 가능한 콘텐츠입니다. 누구나 편집할 수 있지만 편집을 위해서 회원간의 신뢰와 협의가 필요합니다.

### 위키기고

기고는 개인이 작성한 사견이 담긴 글입니다. 쉽게 블로그 포스팅으로 이해하셔도 좋습니다. 작성자가 원할 때 마음대로 편집할 수 있으며 댓글 기능을 사용할 수 있습니다.
