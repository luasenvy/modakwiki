...
!!비회원제
개인정보 처리를 위한 모든 회원 관리 기능과 보안 기능이 모두 구현되어 있으나 현재 비회원제를 유지하고 있습니다.

모닥위키는 "개인정보 처리방침"과 "서비스 약관" 등 법률적인 부분을 보완하기 위한 작업을 진행중입니다. 사업자가 아닌 개인 한 명이 개발/운영하는 사설 사이트로 해결을 위해서 많은 시간이 걸릴 수 있습니다. 관련 사항이 모두 해결되면 회원제로 전환할 예정입니다.
