    ...
    <ShadcnAlert
      className={cn("my-12 shadow-md", {
        ...
        "border-orange-200 bg-orange-50 text-orange-800 *:data-[slot=alert-description]:text-orange-800/90 dark:border-yellow-800 dark:bg-yellow-950/30 dark:text-yellow-200 dark:*:data-[slot=alert-description]:text-yellow-200/90 [&>svg]:text-orange-600 dark:[&>svg]:text-yellow-400":
          isWarning,
        "border-2 border-rose-200 bg-rose-50 text-rose-800 *:data-[slot=alert-description]:text-rose-800/90 dark:border-rose-800 dark:bg-rose-950/30 dark:text-rose-200 dark:*:data-[slot=alert-description]:text-rose-200/90 [&>svg]:text-rose-600 dark:[&>svg]:text-rose-400":
          isDanger,
      })}
      {...props}
    >
